...
create policy "Allow all access for sales" on public.sales for all using (true);
...
create policy "Allow all access for schedules" on public.schedules for all using (true);
...
create policy "Allow all access for survey_measurements" on public.survey_measurements for all using (true);
drop policy if exists "Allow all access for survey_technicians" on public.survey_technicians;
create policy "Allow all access for survey_technicians" on public.survey_technicians for all using (true);
...
create policy "Allow all access for installation_items" on public.installation_items for all using (true);
...
create policy "Allow all access for equipment_units" on public.equipment_units for all using (true);
...
create policy "Allow all access for activity_logs" on public.activity_logs for all using (true);

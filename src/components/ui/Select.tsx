      ...
      <div className="w-full">
        ...
        <div className="relative">
          <select
            id={selectId}
            ref={ref}
            className={`w-full bg-white text-slate-800 text-sm rounded-xl border appearance-none transition-all duration-150 py-2.5 pl-3.5 pr-9 focus:outline-none focus:ring-2 focus:ring-[#B88710]/20 focus:border-[#B88710] disabled:bg-slate-50 disabled:text-slate-400 cursor-pointer ${
